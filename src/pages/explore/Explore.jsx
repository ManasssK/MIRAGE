...
const Explore = () => {
  ...
  const placeholderPosts = [
    {
      id: 1,
      imageUrl: 'https://res.cloudinary.com/dvzlfro0z/image/upload/v1745041278/hotdog_sxelyu.jpg',
      likes: 120,
      comments: 14
    },
    {
      id: 2,
      imageUrl: 'https://res.cloudinary.com/dvzlfro0z/image/upload/v1745041434/for1_wwhgct.jpg',
      likes: 85,
      comments: 7
    },
    {
      id: 3,
      imageUrl: 'https://res.cloudinary.com/dvzlfro0z/image/upload/v1745041345/edu2_llqwdo.jpg',
      likes: 241,
      comments: 32
    },
    {
      id: 4,
      imageUrl: 'https://res.cloudinary.com/dvzlfro0z/image/upload/v1745041278/dosa_ckopkp.jpg',
      likes: 56,
      comments: 3
    },
    {
      id: 5,
      imageUrl: 'https://res.cloudinary.com/dvzlfro0z/image/upload/v1745041434/for2_mwfsgu.jpg',
      likes: 192,
      comments: 21
    },
    {
      id: 6,
      imageUrl: 'https://res.cloudinary.com/dvzlfro0z/image/upload/v1745041433/for3_ijkbii.jpg',
      likes: 78,
      comments: 9
    },
    {
      id: 7,
      imageUrl: 'https://res.cloudinary.com/dvzlfro0z/image/upload/v1745041277/puri_uytc1x.jpg',
      likes: 135,
      comments: 15
    },
    {
      id: 8,
      imageUrl: 'https://res.cloudinary.com/dvzlfro0z/image/upload/v1745041345/edu1_a2bbqt.jpg',
      likes: 64,
      comments: 5
    },
    {
      id: 9,
      imageUrl: 'https://res.cloudinary.com/dvzlfro0z/image/upload/v1745041278/burger_htctcj.jpg',
      likes: 112,
      comments: 18
    }
  ];
